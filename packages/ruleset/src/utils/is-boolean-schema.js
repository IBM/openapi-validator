...
/**
 * Returns `true` if the input is an object with a `type` property of `boolean`. It also accounts
 * for the possibility of a composite schema whose composed schemas consistently reflect this
 * indication of being a boolean schema.
 *
...
module.exports = isBooleanSchema;

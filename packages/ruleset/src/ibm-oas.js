...
module.exports = {
  ...
  rules: {
    ...
    'ibm-discriminator-property-exists': ibmRules.discriminator,
    ...
    'ibm-merge-patch-optional-properties':
      ibmRules.mergePatchOptionalProperties,
    'ibm-missing-required-property': ibmRules.missingRequiredProperty,
    'ibm-no-etag-header': ibmRules.noEtagHeader,

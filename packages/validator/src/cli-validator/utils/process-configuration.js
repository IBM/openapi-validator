    ...
    if (spec === 'spectral') {
      console.log(
        '\n' +
          ...
          ` 'spectral' rules can only be configured through a valid Spectral config file.`
      );
      console.log(
        `Spectral rule settings in the .validaterc file are ignored.`
      );
      return;
    }
...
const lookForSpectralRuleset = async function() {
...
module.exports.lookForSpectralRuleset = lookForSpectralRuleset;

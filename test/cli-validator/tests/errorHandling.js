...
describe ("cli tool - error handling", () => {
	...
	it ("should return an error when there is no filename given", () => {
	...
	it ("should return an error when there is more than one filename given", () => {
	...
	it ("should return an error when there is no file extension", () => {
	...
	it ("should return an error when there is an invalid file extension", () => {
	...
	it ("should return an error when a file contains an invalid object", () => {
